...
internal sealed class DatabaseInitializer(IServiceProvider serviceProvider) : IHostedService
{
    public async Task StartAsync(CancellationToken cancellationToken)
    {
        ...
        {
            new (Guid.NewGuid(),Guid.NewGuid(),"G1", "group 1", GroupType.Public),
            new (Guid.NewGuid(),Guid.NewGuid(),"G2", "group 2 private", GroupType.Private),
            new (Guid.NewGuid(),Guid.NewGuid(),"G3", "group 3", GroupType.Public),
            new (Guid.NewGuid(),Guid.NewGuid(),"G4", "group 4", GroupType.Public),
            new (Guid.NewGuid(),Guid.NewGuid(),"G5", "group 5", GroupType.Public)
        };
